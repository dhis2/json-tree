...
/**
 * Structure of a JSON schema document as described in <a href="https://json-schema.org/draft/2020-12">2020-12 dialect</a>.
 *
 * @author Jan Bernitt
 */
...
public interface JsonSchema {
    ...
    interface JsonValidation extends JsonObject {
        ...
        /**
         * The value of this property MUST be an array. This array SHOULD have at least one element. Elements in the array SHOULD be unique.
         *
        ...
        /**
         * The value of this property MUST be a string. This string SHOULD be a valid regular expression, according to the ECMA-262 regular expression dialect.
         *
         ...
         *
         * @return The number of times that the "contains" property matches must be greater than or equal to the given integer.
         */
        @Validation( minimum = 0)
         ...
         * of an adjacent "contains" property. The first way is if the annotation result is an array and
         * the length of that array is less than or equal to the "maxContains" value. The second way is if the
         * annotation result is a boolean "true" and the instance array length is less than or equal to the
         * "maxContains" value.
         *
         ...
         * The value of this property MUST be a non-negative integer.
         *
         * @return An object instance is valid if its number of properties is greater than, or equal to the given integer.
         */
        @Validation( minimum = 0)
         ...
         * <p>
         * This specifies properties that are required if a specific other property is present. Their
         * requirement is dependent on the presence of the other property.
         * <p>
         *
    ...
    interface JsonMetaData extends JsonObject {
        ...
        /**
         * @return The value of the instance is managed exclusively by the owning authority, and attempts by an application to modify the value of this property are expected to be ignored or rejected by that owning authority.
         */
