...
/**
 * Structure of a JSON schema document as described in <a
...
public interface JsonSchema {
   ...
   *
   * <p>Defines properties that impose requirements for successful validation of an instance.
   */
  interface JsonValidation extends JsonObject {
    ...
    /**
     * The value MUST be either a string or an array. If it is an array, elements of the array MUST
     * be strings and MUST be unique.
     *
     * <p>String values MUST be one of the six primitive type ("null", "boolean", "object", "array",
     * "number", or "string"), or "integer" which matches any number with a zero fractional part.
     *
     * @return Validation succeeds if the type of the instance matches at least one of the given
     *     type.
     */
    @Validation(
        type = STRING,
        ...
        minItems = 0,
        maxItems = 6,
        enumeration = NodeType.class)
    default List<NodeType> $type() {
      return get("type").toListFromVarargs(JsonString.class, str -> str.parsed(NodeType::valueOf));
    }

    /**
     * The value of this property MUST be an array. This array SHOULD have at least one element.
     * Elements in the array SHOULD be unique.
     *
     * @return Validation succeeds if the instance is equal to one of the elements in the given
     *     array.
     */
    ...
    */
    ...
    /**
     * The value of this property MUST be a string. This string SHOULD be a valid regular
     * expression, according to the ECMA-262 regular expression dialect.
     *
     * @return A string instance is considered valid if the regular expression matches the instance
     *     successfully.
     */
    ...
    /**
     * @return Validation succeeds if the numeric instance is greater than or equal to the given
     *     number.
     */
    ...
    /**
     * @return Validation succeeds if the numeric instance is less than or equal to the given
     *     number.
     */
     ...
     * The value of this property MUST be a non-negative integer.
     *
     * @return An array instance is valid if its size is greater than, or equal to, the value of
     *     this keyword.
     */
    @Validation(minimum = 0)
     ...
     * The value of this property MUST be a non-negative integer.
     *
     * @return An array instance is valid if its size is less than, or equal to, the value of this
     *     keyword.
     */
    @Validation(minimum = 0)
     ...
     * The value of this property MUST be a non-negative integer.
     *
     * <p>If "contains" is not present within the same schema object, then this keyword has no
     * effect.
     *
     * <p>An instance array is valid against "minContains" in two ways, depending on the form of the
     * annotation result of an adjacent "contains" property. The first way is if the annotation
     ...
     *
     * <p>A value of 0 is allowed, but is only useful for setting a range of occurrences from 0 to
     * the value of "maxContains". A value of 0 causes "minContains" and "contains" to always pass
     * validation (but validation can still fail against a "maxContains" keyword).
     *
     * @return The number of times that the "contains" property matches must be greater than or
     ...
     * effect.
     *
     * <p>An instance array is valid against "maxContains" in two ways, depending on the form of the
     * annotation result of an adjacent "contains" property. The first way is if the annotation
     ...
     *
     * @return The number of times that the "contains" property matches must be less than or equal
     ...
     * The value of this property MUST be a non-negative integer.
     *
     * @return An object instance is valid if its number of properties is greater than, or equal to
     *     the given integer.
     */
    @Validation(minimum = 0)
     ...
     * The value of this property MUST be a non-negative integer.
     *
     * @return An object instance is valid if its number of properties is less than, or equal to the
     *     given integer.
     */
    @Validation(minimum = 0)
    ...
    /**
     * The value of this property MUST be an array. Elements of this array, if any, MUST be strings,
     * and MUST be unique.
     *
     * @return An object instance is valid if every item in the array is the name of a property in
     *     the instance.
     */
    ...
    /**
     * The value of this property MUST be an object. Properties in this object, if any, MUST be
     * arrays. Elements in each array, if any, MUST be strings, and MUST be unique.
     *
     * <p>This specifies properties that are required if a specific other property is present. Their
     * rule is dependent on the presence of the other property.
     *
     * <p>
     *
     * @return Validation succeeds if, for each name that appears in both the instance and as a name
     *     within the map, every item in the corresponding list is also the name of a property in
     *     the instance.
     */
  ...
  /**
   * Defines properties for general-purpose annotations that provide commonly used information for
   * documentation and user interface display purposes.
   */
  interface JsonMetaData extends JsonObject {

    /**
     * @return A preferably short description about the purpose of the instance described by the
     *     schema.
     */
    ...
    /**
     * @return A sample JSON values associated with a particular schema, for the purpose of
     *     illustrating usage.
     */
    ...
    /**
     * @return The value of the instance is managed exclusively by the owning authority, and
     *     attempts by an application to modify the value of this property are expected to be
