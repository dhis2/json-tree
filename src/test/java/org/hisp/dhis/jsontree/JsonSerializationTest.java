...
class JsonSerializationTest {
  ...
  void testSerializationWithProxy() throws IOException, ClassNotFoundException {
    ...
    assertEquals(rootT0.getDeclaration(), rootT1.getDeclaration(), "The JSON should be identical");
    ...
    assertNotSame(rootT0, rootT1, "Deserialized object should be a new instance");
  }

  @SuppressWarnings("unchecked")
  private static <T> T serialisationRoundTrip(T before) throws IOException, ClassNotFoundException {
    byte[] serializedData;
