    ...
    assertDoesNotThrow(
        () ->
            JsonMixed.of(
                    """
            {"box": "234X"}""")
                .validate(JsonDependentRequiredExampleC.class));
    assertDoesNotThrow(
        () ->
            JsonMixed.of(
                    """
    ...
    assertDoesNotThrow(
        () ->
            JsonMixed.of(
                    """
            {"op":"other"}""")
                .validate(JsonDependentRequiredExampleD.class));
    assertDoesNotThrow(
        () ->
            JsonMixed.of(
                    """
            {"op":"update", "path": "x", "value": null}""")
                .validate(JsonDependentRequiredExampleD.class));
    assertDoesNotThrow(
        () ->
            JsonMixed.of(
                    """
            {"op":"update", "path": "x", "value": 1}""")
                .validate(JsonDependentRequiredExampleD.class));
  }
}
