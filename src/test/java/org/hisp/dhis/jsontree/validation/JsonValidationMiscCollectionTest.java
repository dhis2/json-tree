...
/**
 * Test to demonstrate how annotations can be used to validate types like @{@link JsonIntList} as
 * the automatic Java type analysis will not provide full recursive validation for the items.
 *
 * @author Jan Bernitt
 */
