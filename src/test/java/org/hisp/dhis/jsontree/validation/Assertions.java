...
class Assertions {
    ...
    public static void assertValidationError( String actualJson, Class<? extends JsonValue> schema,
        Validation.Rule expected, Object...args ) {
        assertValidationError( JsonValue.of( actualJson ), schema, expected, args );
    }

    public static void assertValidationError( JsonValue actual, Class<? extends JsonValue> schema,
        Validation.Rule expected, Object...args ) {
