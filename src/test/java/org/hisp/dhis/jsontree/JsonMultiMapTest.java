...
class JsonMultiMapTest {
  ...
  void testToMap_Undefined() {
    ...
    JsonMultiMap<JsonNumber> obj2 =
        JsonMixed.of("null").getObject("a").asMultiMap(JsonNumber.class);
  ...
  void testToMap_NonEmpty() {
    JsonMultiMap<JsonNumber> obj =
        JsonMixed.of("{\"b\":[1],\"c\":[2]}").asMultiMap(JsonNumber.class);
    JsonMultiMap<JsonNumber> obj2 =
        JsonMixed.of("{\"a\":{\"b\":[1],\"c\":[2]}}").getMultiMap("a", JsonNumber.class);
  ...
  void testViewAsMultiMap_NonEmpty() {
    JsonMultiMap<JsonArray> obj =
        JsonMixed.of("{\"b\":[[1]],\"c\":[[2]]}").asMultiMap(JsonArray.class);
    JsonMultiMap<JsonArray> obj2 =
        JsonMixed.of("{\"a\":{\"b\":[[1]],\"c\":[[2]]}}").getMultiMap("a", JsonArray.class);
    assertEquals(
        Map.of("b", List.of(1), "c", List.of(2)),
  ...
  void testToMapWithOrder() {
    JsonMultiMap<JsonNumber> obj =
        JsonMixed.of("{\"b\":[1,2],\"c\":[2,1,5,4]}").asMultiMap(JsonNumber.class);
