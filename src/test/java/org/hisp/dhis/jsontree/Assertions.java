...
public class Assertions {
  ...
  public static Validation.Error assertValidationError(
      String actualJson, Class<?> schema, Validation.Rule expected, Object... args) {
    return assertValidationError(JsonMixed.of(actualJson), schema, expected, args);
  }

  public static Validation.Error assertValidationError(
      JsonObject actual, Class<?> schema, Validation.Rule expected, Object... args) {
  ...
  private static Object textToString(Object arg) {
    ...
    if (arg instanceof Map<?, ?> m)
      return m.entrySet().stream()
          .collect(
              Collectors.toMap(e -> textToString(e.getKey()), e -> textToString(e.getValue())));
    return arg;
  }
}
