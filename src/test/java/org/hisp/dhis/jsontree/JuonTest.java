...
class JuonTest {
  ...
  void testArray_Array() {
    ...
    assertEquals(JsonNode.of("[[[]]]"), JsonNode.ofUrlObjectNotation("((()))"));
    assertEquals(
        JsonNode.of("[[[1,2],[3,4]],[5,6]]"),
        JsonNode.ofUrlObjectNotation("(((1,2),(3,4)),(5,6))"));
  }
  ...
  void testObject() {
    ...
    assertEquals(
        JsonNode.of("{\"no\":1,\"surprises\":{\"please\":true}}"),
  ...
  void testObject_OmitNulls() {
    ...
    assertEquals(
        JsonNode.of("{\"a\":null,\"b\":null,\"c\":3}"),
        JsonNode.ofUrlObjectNotation("(a:,b:,c:3)"));
    assertEquals(
        JsonNode.of("{\"a\":1,\"b\":null,\"c\":3}"), JsonNode.ofUrlObjectNotation("(a:1,b:,c:3)"));
    assertEquals(
        JsonNode.of("{\"a\":1,\"b\":null,\"c\":null}"),
        JsonNode.ofUrlObjectNotation("(a:1,b:,c:)"));
    assertEquals(
        JsonNode.of("{\"a\":1,\"b\":null,\"c\":0.3,\"d\":null,\"e\":5}"),
        JsonNode.ofUrlObjectNotation("(a:1,b:,c:.3,d:,e:5)"));
  }
  ...
  void testObject_Object() {
    ...
    assertEquals(
        JsonNode.of("{\"a\":{\"b\":null},\"c\":{\"d\":null}}"),
        JsonNode.ofUrlObjectNotation("(a:(b:),c:(d:))"));
    assertEquals(
        JsonNode.of("{\"a\":{\"b\":{\"c\":null}}}"), JsonNode.ofUrlObjectNotation("(a:(b:(c:)))"));
    String json =
        """
        {"a":{"b":{"c":1,"d":2},"e":{"f":3,"g":4}},"h":{"i":5,"k":6}}""";
    assertEquals(
        JsonNode.of(json),
        JsonNode.ofUrlObjectNotation("(a:(b:(c:1,d:2),e:(f:3,g:4)),h:(i:5,k:6))"));
  }
